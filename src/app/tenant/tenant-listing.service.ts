...
export class TenantListingService {
  ...
  getAllByCategory(pageRequest: Pagination, category: CategoryName) : void {
    ...
    this.http.get<Page<CardListing>>(`${environment.API_URL}/tenant-listing/get-all-by-category`, {params, withCredentials: true})
      .subscribe({
  ...
  getOneByPublicId(publicId: string): void {
    ...
    this.http.get<Listing>(`${environment.API_URL}/tenant-listing/get-one`, {params, withCredentials: true})
      .subscribe({
  ...
  searchListing(newSearch: Search, pageRequest: Pagination): void {
    ...
    this.http.post<Page<CardListing>>(`${environment.API_URL}/tenant-listing/search`, newSearch, {params, withCredentials: true})
      .subscribe({
