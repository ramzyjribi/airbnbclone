...
export class LandlordListingService {
  ...
  getAll(): void {
    this.http.get<Array<CardListing>>(`${environment.API_URL}/landlord-listing/get-all`,{ withCredentials: true })
      .subscribe({
  ...
  delete(publicId: string): void {
    ...
    this.http.delete<string>(`${environment.API_URL}/landlord-listing/delete`, {params,withCredentials: true})
      .subscribe({
