...
export class AuthService {
  ...
  login(): void {
    ...
    location.href = "http://localhost:8080/oauth2/authorization/okta";
  }
  ...
  fetchHttpUser(forceResync: boolean): Observable<User> {
    ...
    return this.http.get<User>(`${environment.API_URL}/auth/get-authenticated-user`, {params, withCredentials: true})
  }
